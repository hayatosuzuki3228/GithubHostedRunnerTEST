...
namespace Hutzper.Library.Common.Net.Sockets
{
    ...
    /// </summary>
    [Serializable]
    public class TcpBinaryCommunicationClient<T> : SafelyDisposable, ILoggable where T : ITcpBinaryCommunicationLinkage, new()
    {
        #region ILoggable
        ...
        /// バイナリ読み書き
        /// </summary>
        protected readonly T communicationLinkage;
        ...
        public void AysncWrite(ArraySegment<byte> data) => this.communicationLinkage.AysncWrite(data);
