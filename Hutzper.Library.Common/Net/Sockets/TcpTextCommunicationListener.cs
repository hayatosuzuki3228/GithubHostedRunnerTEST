...
namespace Hutzper.Library.Common.Net.Sockets
{
    ...
    /// </summary>
    [Serializable]
    public class TcpTextCommunicationListener : SafelyDisposable, ILoggable
    {
        #region ILoggable
        ...
        public delegate void AcceptTcpClientEventHandler(object sender, TcpTextCommunicationClient client, out bool notUseClient);
        ...
        public TcpTextCommunicationListener(Encoding encoding)
        {
                ...
                void listeningProcess(TcpListener activeListener, ThreadControlFlag controlFlag)
                {
                    try
                    {
                        ...
                        while (false == controlFlag.IsTerminate)
                        {
                            ...
                            // 通信クライアント
                            var comClient = new TcpTextCommunicationClient(this.Encoding);
