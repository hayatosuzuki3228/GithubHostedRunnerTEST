...
public class InsightMekikiData : IInsightMekikiData
{
    ...
    public long UnixtimeUs { get; protected set; }
    ...
    public void Initialize(string uuid, DateTime dateTime, int numberOfValue = 10)
    {
        ...
        // DateTimeをUTCに変換
        var utc = dateTime.Kind == DateTimeKind.Utc ? this.DateTime : this.DateTime.ToUniversalTime();

        // Unixエポック（1970年1月1日）からのマイクロ秒を計算
        this.UnixtimeUs = (utc.Ticks - new DateTime(1970, 1, 1).Ticks) / 10;
